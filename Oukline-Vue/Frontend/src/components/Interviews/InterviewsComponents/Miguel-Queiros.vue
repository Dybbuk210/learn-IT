    ...
    <div class="inner-container main-padding-top">
        <div class="main-container">
            ...
            <div class="interview">
                ...
                <img src="../../../assets/img/Interviews/MiguelQueiros01.webp" alt="">

                <article class="text-card">
                    <InterviewQuestion>
                        We'd like to start by introducing you to our readers, your X account says you're a
                        Web Designer and Framer Developer. Was that always the case, or did you jump onto
                        this design and development path later?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        Is it difficult for you as a designer and developer to fight your way through the
                        competition? How do you go about promoting your services and products?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        You create professional templates in Framer, and we agreed with the team that they
                        look really good. Why did you choose framer as a designer? Did you consider
                        Webflow or Wordpress? After all, WordPress is the most used CMS in the world.
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        Can your design/development business provide you with a living or do you have a
                        full-time job alongside your projects?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        What helped you in your beginnings? Did you watch youtube videos, follow Behance / Dribble
                        or reach for a design book?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        If someone is just deciding to go their own way and learn web design and some CMS,
                        what advice would you give them? Do you have any advice that will help or motivate them?
                    </InterviewQuestion>
                ...
                <img src="../../../assets/img/Interviews/MiguelQueiros02.webp" alt="">

                <article class="text-card">
                    <InterviewQuestion>
                        Times have come fast. Not long ago we were working without AI and today we have
                        Chat GPT, Microsoft Copilot and hundreds of new AI plugins in Figma and other tools
                        for designers and developers. Technology is moving at a meteoric pace.
                        Do you think designers and developers should prepare themselves to work in virtual/augmented
                        reality soon? Will clients soon require us to do special virtual reality design in addition to website design?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                       Do you use any "secret" AI tools or interesting websites that you could recommend to our readers?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        Do you manage to find the so-called work-life balance?
                        Do you manage work, rest and hobbies during the day?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                       What are your plans and goals for the coming months or years?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        ...
                        Do you manage to work without distractions, or do you occasionally stray to Instagram or TikTok?
                    </InterviewQuestion>
                ...
                <article class="text-card">
                    <InterviewQuestion>
                        I'm going to ask you one last question that I found in a book once, and I like it a lot.
                        If you could write something on a billboard that millions of people would see every day,
                        what would it be?
                    </InterviewQuestion>
...
import InterviewText from './InterviewText.vue';
import InterviewStrongText from './InterviewStrongText.vue';
